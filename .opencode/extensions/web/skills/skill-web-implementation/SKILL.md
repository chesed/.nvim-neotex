...
- Path: `.opencode/context/project/web/README.md` - Web context overview
- Path: `.opencode/context/project/web/domain/astro-framework.md` - Astro reference
- Path: `.opencode/context/project/web/domain/tailwind-v4.md` - Tailwind v4 reference
