...
- Path: `.opencode/extensions/web/context/project/web/README.md` - Web context overview
- Path: `.opencode/extensions/web/context/project/web/domain/astro-framework.md` - Astro reference
- Path: `.opencode/extensions/web/context/project/web/domain/tailwind-v4.md` - Tailwind v4 reference
