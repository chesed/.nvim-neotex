...
- `@.opencode/context/project/logic/README.md` - Logic context index (load FIRST)
...
- `@.opencode/context/project/logic/processes/modal-proof-strategies.md`

**Metalogic**:
- `@.opencode/context/project/logic/domain/metalogic-concepts.md`

**Proof Theory**:
- `@.opencode/context/project/logic/domain/proof-theory-concepts.md`
- `@.opencode/context/project/logic/processes/proof-construction.md`

**Standards**:
- `@.opencode/context/project/logic/standards/proof-conventions.md`
- `@.opencode/context/project/logic/standards/notation-standards.md`
- `@.opencode/context/project/logic/standards/naming-conventions.md`
