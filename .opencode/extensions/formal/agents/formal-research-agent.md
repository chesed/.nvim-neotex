...
- `@.opencode/context/project/logic/README.md` - Logic domain index
- `@.opencode/context/project/math/README.md` - Math domain index
- `@.opencode/context/project/physics/README.md` - Physics domain index
