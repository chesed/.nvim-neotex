...
- `@.opencode/context/project/math/topology/topological-spaces.md` - Topological foundations
- `@.opencode/context/project/math/order-theory/partial-orders.md` - Well-foundedness
