...
**Algebra**:
- `@.opencode/context/project/math/algebra/groups-and-monoids.md`
- `@.opencode/context/project/math/algebra/rings-and-fields.md`

**Lattice Theory**:
- `@.opencode/context/project/math/lattice-theory/lattices.md`
- `@.opencode/context/project/math/lattice-theory/bilattice-theory.md`

**Order Theory**:
- `@.opencode/context/project/math/order-theory/partial-orders.md`
- `@.opencode/context/project/math/order-theory/monoidal-posets.md`

**Topology**:
- `@.opencode/context/project/math/topology/topological-spaces.md`
- `@.opencode/context/project/math/topology/scott-topology.md`

**Category Theory**:
- `@.opencode/context/project/math/category-theory/basics.md`
- `@.opencode/context/project/math/category-theory/monoidal-categories.md`

**Foundations**:
- `@.opencode/context/project/math/foundations/dependent-type-theory.md`
