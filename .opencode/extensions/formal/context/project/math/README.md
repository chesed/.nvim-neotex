...
ls -la .opencode/context/project/math/*/
```

## Related Context

- Logic domain: `.opencode/context/project/logic/` - Modal logic and Kripke semantics
- Physics domain: `.opencode/context/project/physics/` - Dynamical systems
