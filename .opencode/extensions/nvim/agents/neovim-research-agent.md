...
- `@.opencode/context/project/neovim/domain/neovim-api.md` - vim.* API patterns
- `@.opencode/context/project/neovim/domain/plugin-ecosystem.md` - Plugin overview
...
- Load relevant context from `.opencode/context/project/neovim/`
