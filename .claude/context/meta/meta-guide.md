...
All generated commands must follow `.claude/context/standards/commands.md` using YAML front matter (including context_level and language) plus XML/@subagent sections; meta outputs should reference `.claude/context/templates/command-template.md`.
