...
{
  "status": "completed",
  "summary": "Research completed on Telescope plugin integration. Found official API documentation. Recommend implementing file picker and live grep first.",
  "artifacts": [
    {
      "type": "research",
  ...
  "errors": [],
  "next_steps": "Create implementation plan for NeovimSearch integration"
}
```
...
{
  "status": "failed",
  "summary": "Failed to implement Neovim configuration due to dependency error. Checked configuration and attempted fallback. Both approaches failed.",
  "artifacts": [],
  "metadata": {
  ...
  "errors": [
    {
      ...
      "recoverable": true,
      "recommendation": "Check that required dependencies are installed"
    }
  ],
  "next_steps": "Install missing dependencies and retry implementation"
}
```
