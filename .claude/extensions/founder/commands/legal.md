...
Mode: {MODE}
Artifact: founder/contract-analysis-{datetime}.md
...
**Note**: Full contract analysis report (`strategy/contract-analysis-*.md`) is generated by `/implement`, not `/legal`.

### Legacy Mode (--quick)

| Artifact | Location |
|----------|----------|
| Contract analysis | `founder/contract-analysis-{datetime}.md` |
...
/implement {N}          -> Executes plan, generates strategy/contract-analysis-*.md
```
