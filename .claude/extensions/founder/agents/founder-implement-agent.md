...
// ============================================================================
// Page Setup and Typography (inlined from strategy-template.typ)
// ============================================================================
...
#set page(
  ...
  header: context {
    if counter(page).get().first() > 1 [
      ...
      {project_name} #h(1fr) Market Sizing Analysis
    ]
  },
  footer: context {
    set text(size: 9pt, fill: gray)
...
// ============================================================================
// Helper Functions (inlined from strategy-template.typ)
// ============================================================================

#let metric-callout(label, value, subtitle: none) = {
  rect(width: 100%, fill: rgb("#e8f4f8"), inset: 12pt, radius: 4pt)[
    #align(center)[
...
#let highlight-box(title: "Key Insight", content) = {
  rect(width: 100%, stroke: (left: 3pt + rgb("#2563eb")), fill: rgb("#f0f7ff"), inset: 12pt)[
...
#let warning-box(title: "Red Flag", content) = {
  rect(width: 100%, stroke: (left: 3pt + rgb("#dc2626")), fill: rgb("#fef2f2"), inset: 12pt)[
...
#align(center)[
  #v(2in)
  #text(size: 28pt, weight: "bold")[Market Sizing Analysis]
  #v(0.5em)
  #text(size: 14pt, fill: gray)[{project_name}]
  #v(2em)
...
= Executive Summary
#rect(width: 100%, fill: rgb("#f5f5f5"), inset: 16pt, radius: 4pt)[
