...
- **374** [PLANNED] -- Update skill-founder-implement artifact reporting for typst (depends: 373)
- **375** [PLANNED] -- Update founder command docs to reference typst output paths (depends: 373)
