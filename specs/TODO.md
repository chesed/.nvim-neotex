...
- **407** [COMPLETED] -- Update present/ manifest.json and extension metadata (depends: 403, 405)
...
- **Plan**: [01_present-manifest-metadata.md](specs/407_update_present_manifest_and_metadata/plans/01_present-manifest-metadata.md)
- **Summary**: [01_present-manifest-summary.md](specs/407_update_present_manifest_and_metadata/summaries/01_present-manifest-summary.md)
